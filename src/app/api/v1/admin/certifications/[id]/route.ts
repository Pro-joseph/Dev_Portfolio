...
export async function GET(request: Request, { params }: { params: Promise<{ id: string }> }): Promise<Response> {
  ...
  try {
    return await resourceShow("certifications", parsed, request);
  } catch (e) {
...
export async function PATCH(request: Request, { params }: { params: Promise<{ id: string }> }): Promise<Response> {
  ...
  if (parsed === null) return notFound();
  try {
    return await resourceUpdate("certifications", parsed, request);
  } catch (e) {
    return handleError(e);
  }
}
...
export async function DELETE(request: Request, { params }: { params: Promise<{ id: string }> }): Promise<Response> {
  ...
  if (parsed === null) return notFound();
  try {
    return await resourceDestroy("certifications", parsed, request);
  } catch (e) {
    return handleError(e);
  }
}
