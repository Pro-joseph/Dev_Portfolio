-- SQLite schema mirroring the Laravel migrations.
-- ids are INTEGER PRIMARY KEY; id assignment is handled by the app via MAX(id)+1.
-- Booleans are stored as 0/1; timestamps as ISO-8601 TEXT.
...
CREATE TABLE IF NOT EXISTS skills (
  id INTEGER PRIMARY KEY,
  skill_category_id INTEGER NULL REFERENCES skill_categories(id) ON DELETE SET NULL,
  name TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS testimonials (
  ...
  locale TEXT NOT NULL DEFAULT 'en',
  role TEXT NULL,
  avatar_media_id INTEGER NULL REFERENCES media(id) ON DELETE SET NULL,
  order_index INTEGER NOT NULL DEFAULT 0,
  is_visible INTEGER NOT NULL DEFAULT 1,
  created_at TEXT NULL,
  updated_at TEXT NULL
